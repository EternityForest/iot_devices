...
class Device():
    ...
    def numeric_data_point(self,name:str, min:Optional[float]=None, max:Optional[float]=None, 
            hi:Optional[float]=None, lo:Optional[float]=None, description:str="", unit:str='', handler:Optional[Callable]=None,
            default:float=0):
        ...
        def onChangeAttempt(v:float, t, a):
            v = float(v)
            v =minimum(max, v)
            v = maximum(min, v)
    ...
    def string_data_point(self,name:str, description:str="", handler:Optional[Callable]=None):
        """register a new string data point with the given properties. handler will be called when it changes.
        only meant to be called from within __init__.
        """
        
    def object_data_point(self,name:str, description:str="", handler:Optional[Callable]=None):
    ...
    def set_data_point(self, name:str, value, timestamp:Optional[float]=None, annotation:Optional[float]=None):
        """
