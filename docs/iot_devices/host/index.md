...
### *class* iot_devices.host.DeviceHostContainer(host: [Host](#iot_devices.host.Host), parent_container: [DeviceHostContainer](#iot_devices.host.DeviceHostContainer) | None, device_config: collections.abc.Mapping[str, Any])
