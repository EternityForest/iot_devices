        ...
        def numeric_data_point(self, name, writable=True, default=0, unit='', subtype='', **kwargs):
            ...
            with lock:
                ...
                if not writable:
                    ...
                    def set(*a):
                        self.set_data_point(name, (self.datapoints.get(name,0) or 0) + 1)
                    b = Button("go", set)
                    ...
                    def toggle(*a):
                        self.set_data_point(name, 0 if(self.datapoints.get(name,0) or 0)>0.5 else 1)
